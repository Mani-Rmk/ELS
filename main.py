...
app.include_router(employee_router, prefix="/crud", tags=["Employee CRUD"])
app.include_router(employee_leave_router, prefix="/crud", tags=["Employee Leave CRUD"])

# Leave request endpoint
@app.post("/leave/request",tags=["Leave Management"], summary="Submit leave request", description="Submit a leave request for an employee. Sends an email to the manager.")
...
@app.post("/leave/approval", tags=["Leave Management"], summary="Approve or reject leave request", description="Manager can approve or reject a leave request. Sends an email to the employee.")
